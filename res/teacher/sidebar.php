	...
	<div class="menu-list">
		<ul id="menu-content" class="menu-content collapse out">
			...
			<li  data-toggle="collapse" data-target="#member" class="collapsed">
				<a><i class="fa fa-money fa-lg"></i> Tiền tệ<span class="arrow"></span></a>
			</li>
			<ul class="sub-menu collapse" id="member">
				<li><a href="<?php echo base_url('admin_panel/qltv') ?>"> Quản lý tiền tệ</a></li>
				<li><a href="<?php echo base_url('admin_panel/add_user') ?>"> Thanh toán</a></li>
				<li><a href="<?php echo base_url('admin_panel/chart_user') ?>"> Thống kê tiền tệ</a></li>
			</ul>
